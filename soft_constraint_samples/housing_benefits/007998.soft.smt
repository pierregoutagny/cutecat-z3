...
(assert (let ((a!1 ((_ !round! 0)
      ...
      (a!2 ((_ !round! 0)
             (+ (- 5186.0) (* 5186.0 (to_real |nombre_personnes_à_charge_in|))))))
(let ((a!3 (* 100.0 (/ (to_real loyer_principal_in) (+ 35630.0 (to_real a!2))))))
(let ((a!4 (+ (- 375.0) (* (/ 34.0 5.0) (to_real ((_ !round! 0) a!3))))))
(let ((a!5 (+ (/ 209.0 10000.0)
...
(let ((a!2 ((_ !round! 0)
             (+ (/ 45883.0 200.0)
                (* (/ 17.0 200.0) (to_real loyer_principal_in))
                (* (/ 17.0 200.0) a!1))))
      (a!5 (* 100.0 (/ (to_real loyer_principal_in) (+ 35630.0 (to_real a!4))))))
(let ((a!6 (+ (- 375.0) (* (/ 34.0 5.0) (to_real ((_ !round! 0) a!5))))))
(let ((a!7 (+ (/ 209.0 10000.0)
              (* (- (/ 3.0 5000.0)) (to_real |nombre_personnes_à_charge_in|))
