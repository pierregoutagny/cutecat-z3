...
(assert (not (and (>= date_courante_in 5021)
          (= situation_familiale_calcul_apl_in (mk!Couple unit))
          (= |nombre_personnes_à_charge_in| 0))))
(assert (and (>= date_courante_in 5021) (>= |nombre_personnes_à_charge_in| 1)))
...
(assert (let ((a!1 ((_ !round! 0)
             (+ (- 6315.0) (* 6315.0 (to_real |nombre_personnes_à_charge_in|))))))
(let ((a!2 (<= ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in)))
               (+ 43524 a!1))))
  (not a!2))))
(assert (let ((a!1 ((_ !round! 0)
             (+ (- 6315.0) (* 6315.0 (to_real |nombre_personnes_à_charge_in|))))))
(let ((a!2 ((_ !round! 0) (+ (/ 739908.0 5.0) (* (/ 17.0 5.0) (to_real a!1)))))
      (a!3 ((_ !round! 0) (+ 108810.0 (* (/ 5.0 2.0) (to_real a!1))))))
  (>= a!2 a!3))))
(assert (>= date_courante_in 5021))
(assert (let ((a!1 ((_ !round! 0)
             (+ (- 6315.0) (* 6315.0 (to_real |nombre_personnes_à_charge_in|)))))
...
(assert (let ((a!1 ((_ !round! 0)
      ...
      (a!2 ((_ !round! 0)
             (+ (- 5579.0) (* 5579.0 (to_real |nombre_personnes_à_charge_in|))))))
(let ((a!3 (* 100.0 (/ (+ 43524.0 (to_real a!1)) (+ 38328.0 (to_real a!2))))))
...
(assert (let ((a!1 ((_ !round! 0)
      ...
      (a!3 ((_ !round! 0)
             (+ (- 5579.0) (* 5579.0 (to_real |nombre_personnes_à_charge_in|))))))
(let ((a!4 (* 100.0 (/ (+ 43524.0 (to_real a!2)) (+ 38328.0 (to_real a!3))))))
...
(let ((a!3 ((_ !round! 0)
             (+ (/ 209661.0 50.0)
                (* (/ 17.0 200.0) (to_real a!1))
                (* (/ 17.0 200.0) a!2))))
      (a!6 (* 100.0 (/ (+ 43524.0 (to_real a!1)) (+ 38328.0 (to_real a!5))))))
(let ((a!7 (+ (- 375.0) (* (/ 34.0 5.0) (to_real ((_ !round! 0) a!6))))))
(let ((a!8 (+ (/ 209.0 10000.0)
              (* (- (/ 3.0 5000.0)) (to_real |nombre_personnes_à_charge_in|))
              (* (/ 1.0 100000.0) (to_real ((_ !round! 0) a!7))))))
(let ((a!9 (* (+ (- 997500.0)
                 (to_real |ressources_ménage_arrondies_in|)
                 (* (- 1.0) (to_real a!4)))
              a!8)))
