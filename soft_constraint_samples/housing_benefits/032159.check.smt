...
(assert (not ((_ is mk!Zone2) zone_in)))
(assert ((_ is mk!Zone1) zone_in))
(assert (<= ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in))) 27765))
(assert (not (>= date_courante_in 5021)))
(assert (and (>= date_courante_in 4564) (not (<= 5021 date_courante_in))))
...
(assert (and (>= date_courante_in 4564) (not (<= 5021 date_courante_in))))
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in))))))
  (>= (to_real ((_ !round! 0) (* (/ 10.0 3291.0) a!1))) 45.0)))
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in))))))
(let ((a!2 (>= (to_real ((_ !round! 0) (* (/ 10.0 3291.0) a!1))) 45.0))
      (a!3 (>= (to_real ((_ !round! 0) (* (/ 10.0 3291.0) a!1))) 75.0)))
  (and a!2 (not a!3)))))
(assert (not (and (>= date_courante_in 3926) (not (<= 4291 date_courante_in)))))
(assert (not (and (>= date_courante_in 4291) (not (<= 4564 date_courante_in)))))
(assert (and (>= date_courante_in 4564) (not (<= 5021 date_courante_in))))
...
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in))))))
(let ((a!2 (* (/ 9.0 2.0) (to_real ((_ !round! 0) (* (/ 10.0 3291.0) a!1))))))
(let ((a!3 (* (/ 1.0 100000.0)
              (to_real ((_ !round! 0) (+ (- (/ 405.0 2.0)) a!2))))))
(let ((a!4 ((_ !round! 0)
             (* (+ (- 697700.0) (to_real |ressources_ménage_arrondies_in|))
                (+ (/ 63.0 2000.0) a!3)))))
  (not (<= 0 a!4)))))))
