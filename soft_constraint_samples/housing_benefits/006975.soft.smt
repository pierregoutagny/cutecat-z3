...
(assert (let ((a!1 ((_ !round! 0)
             (+ (- 4403.0) (* 4403.0 (to_real |nombre_personnes_à_charge_in|))))))
  (<= loyer_principal_in (+ 30345 a!1))))
(assert (let ((a!1 ((_ !round! 0)
             (+ (- 4403.0) (* 4403.0 (to_real |nombre_personnes_à_charge_in|))))))
(let ((a!2 ((_ !round! 0) (+ 103173.0 (* (/ 17.0 5.0) (to_real a!1)))))
      (a!3 ((_ !round! 0) (+ (/ 151725.0 2.0) (* (/ 5.0 2.0) (to_real a!1))))))
  (>= a!2 a!3))))
(assert (not (>= date_courante_in 5021)))
(assert (not (and (>= date_courante_in 4564) (not (<= 5021 date_courante_in)))))
(assert (not (and (>= date_courante_in 4291) (not (<= 4564 date_courante_in)))))
...
(assert (let ((a!1 ((_ !round! 0)
             (+ (- 5186.0) (* 5186.0 (to_real |nombre_personnes_à_charge_in|))))))
(let ((a!2 (* 100.0 (/ (to_real loyer_principal_in) (+ 35630.0 (to_real a!1))))))
...
(let ((a!4 (+ (/ 179.0 10000.0)
              (* (/ 1.0 100000.0) (to_real ((_ !round! 0) a!3))))))
(let ((a!5 ((_ !round! 0)
             (* (+ (- 893800.0) (to_real |ressources_ménage_arrondies_in|))
                a!4))))
  (not (<= 0 a!5))))))))
