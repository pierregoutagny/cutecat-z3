...
(assert (not ((_ is mk!Zone2) zone_in)))
(assert ((_ is mk!Zone1) zone_in))
(assert (<= ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in))) 23948))
(assert (>= date_courante_in 5021))
...
(assert (>= date_courante_in 5021))
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in))))))
  (>= (to_real ((_ !round! 0) (* (/ 25.0 6957.0) a!1))) 45.0)))
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in))))))
(let ((a!2 (>= (to_real ((_ !round! 0) (* (/ 25.0 6957.0) a!1))) 45.0))
      (a!3 (>= (to_real ((_ !round! 0) (* (/ 25.0 6957.0) a!1))) 75.0)))
  (not (and a!2 (not a!3))))))
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in))))))
(let ((a!2 (>= (to_real ((_ !round! 0) (* (/ 25.0 6957.0) a!1))) 75.0)))
  (not a!2))))
