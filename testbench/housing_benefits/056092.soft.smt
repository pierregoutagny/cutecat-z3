...
(assert (let ((a!1 ((_ !round! 0)
             (+ (- 4736.0) (* 4736.0 (to_real |nombre_personnes_à_charge_in|))))))
(let ((a!2 (<= ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in)))
               (+ 32643 a!1))))
  (not a!2))))
(assert (let ((a!1 ((_ !round! 0)
             (+ (- 4736.0) (* 4736.0 (to_real |nombre_personnes_à_charge_in|))))))
(let ((a!2 ((_ !round! 0) (+ (/ 554931.0 5.0) (* (/ 17.0 5.0) (to_real a!1)))))
      (a!3 ((_ !round! 0) (+ (/ 163215.0 2.0) (* (/ 5.0 2.0) (to_real a!1))))))
  (>= a!2 a!3))))
(assert (>= date_courante_in 5021))
(assert (let ((a!1 ((_ !round! 0)
             (+ (- 4736.0) (* 4736.0 (to_real |nombre_personnes_à_charge_in|)))))
...
(assert (let ((a!1 ((_ !round! 0)
      ...
      (a!2 ((_ !round! 0)
             (+ (- 5579.0) (* 5579.0 (to_real |nombre_personnes_à_charge_in|))))))
(let ((a!3 (* 100.0 (/ (+ 32643.0 (to_real a!1)) (+ 38328.0 (to_real a!2))))))
