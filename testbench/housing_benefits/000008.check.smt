...
(assert (not ((_ is mk!Zone2) zone_in)))
(assert ((_ is mk!Zone1) zone_in))
(assert (<= ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in))) 22262))
(assert (not (>= date_courante_in 5021)))
(assert (not (and (>= date_courante_in 4564) (not (<= 5021 date_courante_in)))))
(assert (not (and (>= date_courante_in 4291) (not (<= 4564 date_courante_in)))))
(assert (and (not (<= 4291 date_courante_in)) (>= date_courante_in 3926)))
...
(assert (and (>= date_courante_in 3926) (not (<= 4291 date_courante_in))))
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in))))))
(let ((a!2 (>= (to_real ((_ !round! 0) (* (/ 100.0 25869.0) a!1))) 45.0)))
  (not (not a!2)))))
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in))))))
(let ((a!2 (>= (to_real ((_ !round! 0) (* (/ 100.0 25869.0) a!1))) 45.0))
      (a!3 (>= (to_real ((_ !round! 0) (* (/ 100.0 25869.0) a!1))) 75.0)))
  (not (and a!2 (not a!3))))))
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in))))))
  (>= (to_real ((_ !round! 0) (* (/ 100.0 25869.0) a!1))) 75.0)))
(assert (and (>= date_courante_in 3926) (not (<= 4291 date_courante_in))))
(assert (not (= 100000.0 (to_real 0))))
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in))))))
(let ((a!2 (* (/ 34.0 5.0) (to_real ((_ !round! 0) (* (/ 100.0 25869.0) a!1))))))
(let ((a!3 (* (/ 1.0 100000.0) (to_real ((_ !round! 0) (+ (- 375.0) a!2))))))
(let ((a!4 ((_ !round! 0)
             (* (+ (- 458800.0) (to_real |ressources_ménage_arrondies_in|))
                (+ (/ 283.0 10000.0) a!3)))))
  (not (<= 0 a!4)))))))
