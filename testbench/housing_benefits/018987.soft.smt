...
(assert (let ((a!1 (not (and (not (<= 4383 date_courante_in))
                     (>= date_courante_in 3652)))))
  (not a!1)))
(assert (not (and (>= date_courante_in 3926) (not (<= 4291 date_courante_in)))))
(assert (and (>= date_courante_in 4291) (not (<= 4564 date_courante_in))))
...
(assert (let ((a!1 ((_ !round! 0)
             (+ (- 4743.0) (* 4743.0 (to_real |nombre_personnes_à_charge_in|))))))
...
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in)))))
  ...
  (>= ((_ !round! 0)
        (+ (/ 46087.0 100.0) (* (/ 17.0 200.0) a!1) (* (/ 17.0 200.0) a!2)))
      3539)))
(assert (not (and (not (<= 4291 date_courante_in)) (>= date_courante_in 3926))))
(assert (not (and (>= date_courante_in 3926) (not (<= 4291 date_courante_in)))))
(assert (and (>= date_courante_in 4291) (not (<= 4564 date_courante_in))))
...
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in)))))
      (a!2 ((_ !round! 0)
             (+ (- 5208.0) (* 5208.0 (to_real |nombre_personnes_à_charge_in|))))))
(let ((a!3 (* 100.0 (/ a!1 (+ 35780.0 (to_real a!2))))))
...
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in)))))
      (a!2 ((_ !round! 0)
             (+ (- 5208.0) (* 5208.0 (to_real |nombre_personnes_à_charge_in|))))))
(let ((a!3 (* 100.0 (/ a!1 (+ 35780.0 (to_real a!2))))))
(let ((a!4 (+ (- (/ 405.0 2.0)) (* (/ 9.0 2.0) (to_real ((_ !round! 0) a!3))))))
(let ((a!5 (+ (/ 173.0 10000.0)
              (* (/ 1.0 100000.0) (to_real ((_ !round! 0) a!4))))))
(let ((a!6 ((_ !round! 0)
             (* (+ (- 924600.0) (to_real |ressources_ménage_arrondies_in|))
                a!5))))
  (not (not (<= 0 a!6)))))))))
(assert (let ((a!1 (to_real ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in)))))
      (a!2 (to_real ((_ !round! 0)
...
(let ((a!3 (* (- 1)
              ((_ !round! 0)
                (+ (/ 46087.0 100.0)
                   (* (/ 17.0 200.0) a!1)
                   (* (/ 17.0 200.0) a!2)))))
      (a!5 (* 100.0 (/ a!1 (+ 35780.0 (to_real a!4))))))
(let ((a!6 (+ (- (/ 405.0 2.0)) (* (/ 9.0 2.0) (to_real ((_ !round! 0) a!5))))))
(let ((a!7 (+ (/ 173.0 10000.0)
              (* (/ 1.0 100000.0) (to_real ((_ !round! 0) a!6))))))
(let ((a!8 ((_ !round! 0)
             (* (+ (- 924600.0) (to_real |ressources_ménage_arrondies_in|))
                a!7))))
(let ((a!9 (+ ((_ !round! 0) (* (/ 2.0 3.0) (to_real loyer_principal_in)))
              ((_ !round! 0)
                (* 1229.0 (to_real |nombre_personnes_à_charge_in|)))
              a!3
              (* (- 1) a!8))))
