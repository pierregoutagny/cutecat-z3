...
(assert (= |nombre_personnes_à_charge_in| 5))
...
(assert (not (and (>= date_courante_in 4564) (not (<= 5021 date_courante_in)))))
(assert (>= date_courante_in 5021))
(assert (and (>= date_courante_in 5021) colocation_in))
...
(assert (not (and (>= date_courante_in 5021)
          ...
          (= |nombre_personnes_à_charge_in| 0))))
(assert (and (>= date_courante_in 5021)
     colocation_in
...
(assert (let ((a!1 ((_ !round! 0)
             (+ (- 3811.0) (* 3811.0 (to_real |nombre_personnes_à_charge_in|))))))
  (not (<= loyer_principal_in (+ 26588 a!1)))))
(assert (>= date_courante_in 5021))
(assert (let ((a!1 ((_ !round! 0)
             (+ (- 3811.0) (* 3811.0 (to_real |nombre_personnes_à_charge_in|)))))
...
(assert (let ((a!1 ((_ !round! 0)
      ...
      (a!2 ((_ !round! 0)
             (+ (- 5579.0) (* 5579.0 (to_real |nombre_personnes_à_charge_in|))))))
(let ((a!3 (* 100.0 (/ (+ 26588.0 (to_real a!1)) (+ 38328.0 (to_real a!2))))))
...
(let ((a!5 (+ (/ 179.0 10000.0)
              (* (/ 1.0 100000.0) (to_real ((_ !round! 0) a!4))))))
(let ((a!6 ((_ !round! 0)
             (* (+ (- 964200.0) (to_real |ressources_ménage_arrondies_in|))
                a!5))))
  (not (not (<= 0 a!6)))))))))
(assert (let ((a!1 ((_ !round! 0)
             (+ (- 3811.0) (* 3811.0 (to_real |nombre_personnes_à_charge_in|)))))
...
(let ((a!3 ((_ !round! 0)
             (+ (/ 501347.0 200.0)
                (* (/ 17.0 200.0) (to_real a!1))
                (* (/ 17.0 200.0) a!2))))
      (a!5 (* 100.0 (/ (+ 26588.0 (to_real a!1)) (+ 38328.0 (to_real a!4))))))
(let ((a!6 (+ (- (/ 405.0 2.0)) (* (/ 9.0 2.0) (to_real ((_ !round! 0) a!5))))))
(let ((a!7 (+ (/ 179.0 10000.0)
